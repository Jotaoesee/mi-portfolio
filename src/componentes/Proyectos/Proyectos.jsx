    ...
    <section id="proyectos" className="seccion-proyectos">
      <div className="contenedor-proyectos">
        <header className="cabecera-proyectos">
          ...
          <p className="subtitulo-seccion">Proyectos que he desarrollado</p>
        </header>
        
        <div className="rejilla-proyectos">
          {listaProyectos.map((proyecto, indice) => (
            <article className="tarjeta-proyecto" key={indice}>
              <div className="visual-proyecto">
                <span className="icono-grande">{proyecto.icono}</span>
              </div>
              ...
              <div className="pie-proyecto">
                <a href={proyecto.enlace} className="enlace-icono" target="_blank" rel="noopener noreferrer">
                  <svg 
                    className="svg-icono" 
                    viewBox="0 0 24 24" 
                ...
                <a href={proyecto.enlace} className="enlace-icono" target="_blank" rel="noopener noreferrer">
                  <svg className="svg-icono" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
